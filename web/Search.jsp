...
<html lang="en">
    ...
    <body id="page-top">
        <%@ page import = "com.java.bean.RecordBean, com.java.dao.RecordDao, java.util.*"%>
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <%
                                              ...
                                              disp = RecordDao.getAllRecords();
                                              try {
                                               if(request.getParameter("submit").equals("Show")){
                    ...
                    <!-- Page Content -->
                     <div class="container">
                         <form class="form-inline mb-2" action="Search.jsp" >
                           ...
                           <input type = "submit" name ="submit" value ="Show" class="btn btn-primary mb-2"  >
